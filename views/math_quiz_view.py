"""View для математической викторины."""
...
class MathQuizView(discord.ui.View):
    ...
    def __init__(self, guild_id: int, user_id: int, bet: int, question: str, answer: int, difficulty: str):
    ...
    @discord.ui.button(label="Ответить", style=discord.ButtonStyle.primary, custom_id="math_answer")
    async def answer_button(self, interaction: discord.Interaction, button: discord.ui.Button) -> None:
        ...
        await interaction.response.send_modal(MathAnswerModal(self.guild_id, self.user_id, self.bet, self.question, self.answer, self.difficulty))


class MathAnswerModal(discord.ui.Modal, title="Ваш ответ"):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        multiplier = 2.0 if self.difficulty == "easy" else 3.0
